...
#endif
const uint8_t native_palettes[3][3][128] = {
    ...
    { // MXOS palette
        {0, 9, 18, 27, 36, 45, 54, 63, 4, 9, 20, 47, 6, 12, 25, 63, 4, 9, 20, 45, 6, 12, 25, 61, 3, 6, 14, 35, 3, 7, 16, 41, 2, 4, 10, 25, 1, 3, 8, 20, 1, 2, 5, 15, 0, 0, 0, 0, 1, 2, 5, 15, 0, 0, 0, 0, 1, 2, 5, 15, 0, 0, 0, 0, 1, 2, 5, 15, 0, 0, 0, 0, 0, 2, 5, 15, 0, 0, 0, 0, 0, 5, 10, 25, 1, 3, 8, 20, 3, 6, 14, 34, 3, 7, 16, 41, 4, 9, 19, 44, 6, 12, 25, 63, 4, 9, 19, 44, 6, 12, 25, 63, 4, 9, 19, 44, 6, 12, 25, 63, 4, 9, 19, 46, 6, 12, 25, 63},
        {0, 9, 18, 27, 36, 45, 54, 63, 1, 2, 5, 15, 0, 0, 0, 0, 1, 3, 5, 15, 0, 0, 0, 0, 1, 3, 5, 15, 0, 0, 0, 0, 1, 2, 5, 15, 0, 0, 0, 0, 1, 2, 5, 15, 0, 0, 0, 0, 3, 5, 12, 30, 3, 5, 12, 31, 4, 9, 19, 46, 6, 11, 24, 62, 4, 9, 20, 47, 6, 12, 25, 63, 5, 9, 19, 47, 6, 12, 25, 63, 5, 9, 20, 47, 6, 12, 25, 63, 4, 9, 19, 44, 6, 12, 25, 63, 4, 9, 19, 44, 6, 12, 25, 63, 3, 6, 14, 34, 3, 7, 16, 41, 2, 5, 10, 24, 1, 3, 8, 20, 1, 2, 5, 15, 0, 0, 0, 0},
        {0, 9, 18, 27, 36, 45, 54, 63, 2, 4, 10, 25, 1, 3, 8, 20, 3, 6, 14, 35, 3, 7, 16, 40, 4, 9, 20, 45, 6, 12, 25, 62, 4, 9, 20, 47, 6, 12, 25, 63, 4, 9, 20, 47, 6, 12, 25, 63, 4, 9, 20, 47, 6, 12, 25, 63, 4, 9, 20, 47, 6, 12, 25, 63, 3, 6, 13, 31, 3, 5, 12, 31, 1, 2, 5, 15, 0, 0, 0, 0, 1, 2, 5, 15, 0, 0, 0, 0, 1, 2, 5, 14, 0, 0, 0, 0, 1, 2, 5, 14, 0, 0, 0, 0, 1, 2, 5, 14, 0, 0, 0, 0, 1, 2, 5, 14, 0, 0, 0, 0, 1, 2, 5, 15, 0, 0, 0, 0}
    }
};

uint8_t __attribute__((section(".cfw_bss"))) temporary_palette[3][128];